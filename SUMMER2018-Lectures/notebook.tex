...
{\color{incolor}In [{\color{incolor}79}]:} \PY{k+kn}{from} \PY{n+nn}{lxml} \PY{k}{import} \PY{n}{etree}
...
possible.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}3}]:} \PY{n}{ns} \PY{o}{=} \PY{p}{\PYZob{}}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{tei}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{http://www.tei\PYZhy{}c.org/ns/1.0}\PY{l+s+s1}{\PYZsq{}}\PY{p}{\PYZcb{}}
\end{Verbatim}
...
Let's put this together and see the results.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}8}]:} \PY{n+nb}{print}\PY{p}{(}\PY{n}{tree}\PY{o}{.}\PY{n}{xpath}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{//tei:person[@xml:id = }\PY{l+s+s1}{\PYZdq{}}\PY{l+s+s1}{F\PYZhy{}ham\PYZhy{}ham}\PY{l+s+s1}{\PYZdq{}}\PY{l+s+s1}{]/tei:persName[@type = }\PY{l+s+s1}{\PYZdq{}}\PY{l+s+s1}{standard}\PY{l+s+s1}{\PYZdq{}}\PY{l+s+s1}{]/text()}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{namespaces} \PY{o}{=} \PY{n}{ns}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
...
now it will select all the person nodes.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}11}]:} \PY{n}{results} \PY{o}{=} \PY{n}{tree}\PY{o}{.}\PY{n}{xpath}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{//tei:person/tei:persName[@type = }\PY{l+s+s1}{\PYZdq{}}\PY{l+s+s1}{standard}\PY{l+s+s1}{\PYZdq{}}\PY{l+s+s1}{]/text()}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{namespaces} \PY{o}{=} \PY{n}{ns}\PY{p}{)}
...
How many characters have standard names?
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}12}]:} \PY{n+nb}{print}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{results}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
...
33
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}15}]:} \PY{k}{for} \PY{n}{name} \PY{o+ow}{in} \PY{n}{results}\PY{p}{:}
...
\texttt{//tei:sp{[}@who\ =\ "\#F-ham-ham"{]}/tei:speaker/text()}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}21}]:} \PY{n}{results} \PY{o}{=} \PY{n}{tree}\PY{o}{.}\PY{n}{xpath}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{//tei:sp[@who = }\PY{l+s+s1}{\PYZdq{}}\PY{l+s+s1}{\PYZsh{}F\PYZhy{}ham\PYZhy{}ham}\PY{l+s+s1}{\PYZdq{}}\PY{l+s+s1}{]/tei:speaker/text()}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{namespaces} \PY{o}{=} \PY{n}{ns}\PY{p}{)}
         \PY{n+nb}{print}\PY{p}{(}\PY{n}{results}\PY{p}{)}
...
340
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}22}]:} \PY{k+kn}{from} \PY{n+nn}{collections} \PY{k}{import} \PY{n}{Counter}
...
write this in two queries.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}23}]:} \PY{n}{stagedirtype} \PY{o}{=} \PY{n}{tree}\PY{o}{.}\PY{n}{xpath}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{//tei:sp/tei:stage/@type}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{namespaces}\PY{o}{=}\PY{n}{ns}\PY{p}{)}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}24}]:} \PY{n}{stagedirtext} \PY{o}{=} \PY{n}{tree}\PY{o}{.}\PY{n}{xpath}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{//tei:sp/tei:stage/text()}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{namespaces}\PY{o}{=}\PY{n}{ns}\PY{p}{)}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}25}]:} \PY{n+nb}{print}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{stagedirtype}\PY{p}{)}\PY{p}{)}
...
notations on the end.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}26}]:} \PY{n}{stagedirswithtype} \PY{o}{=} \PY{n}{tree}\PY{o}{.}\PY{n}{xpath}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{//tei:sp/tei:stage[@type]}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{namespaces}\PY{o}{=}\PY{n}{ns}\PY{p}{)}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}27}]:} \PY{n}{stagedirswithtype}
\end{Verbatim}
...
don't need anything fancy for that.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}29}]:} \PY{k}{for} \PY{n}{stageelem} \PY{o+ow}{in} \PY{n}{stagedirswithtype}\PY{p}{:}
...
onto this.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}36}]:} \PY{k}{for} \PY{n}{stage} \PY{o+ow}{in} \PY{n}{stagedirswithtype}\PY{p}{:}
...
['business']
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}38}]:} \PY{k}{for} \PY{n}{stage} \PY{o+ow}{in} \PY{n}{stagedirswithtype}\PY{p}{:}
...
xpath expression.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}39}]:} \PY{k}{for} \PY{n}{stage} \PY{o+ow}{in} \PY{n}{stagedirswithtype}\PY{p}{:}
...
the results.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}48}]:} \PY{k}{for} \PY{n}{stage} \PY{o+ow}{in} \PY{n}{stagedirswithtype}\PY{p}{:}
...
You get an empty list.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}50}]:} \PY{n+nb}{print}\PY{p}{(}\PY{n}{tree}\PY{o}{.}\PY{n}{xpath}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{tei:frogs/text()}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{namespaces}\PY{o}{=}\PY{n}{ns}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
...
will be purely as a list.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}84}]:} \PY{k}{def} \PY{n+nf}{checkFor1Result}\PY{p}{(}\PY{n}{xpathresult}\PY{p}{,} \PY{n}{missing\PYZus{}value}\PY{p}{)}\PY{p}{:}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}85}]:} \PY{c+c1}{\PYZsh{} raises an error and halts the program if there are more than 1}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
        ...
        <ipython-input-85-ea46f41c19ff> in <module>()
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}86}]:} \PY{c+c1}{\PYZsh{} passes the value through if there are exactly 1}
...
yup
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}87}]:} \PY{c+c1}{\PYZsh{} passes the missing result through if there\PYZsq{}s nothing.}
...
Let's see this in action on all 33 stage elements.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}88}]:} \PY{n}{allstages} \PY{o}{=} \PY{n}{tree}\PY{o}{.}\PY{n}{xpath}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{//tei:sp/tei:stage}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{namespaces}\PY{o}{=}\PY{n}{ns}\PY{p}{)}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}89}]:} \PY{k}{for} \PY{n}{stage} \PY{o+ow}{in} \PY{n}{allstages}\PY{p}{:}
             \PY{n}{results} \PY{o}{=} \PY{p}{[}\PY{p}{]}
             \PY{n}{who} \PY{o}{=} \PY{n}{stage}\PY{o}{.}\PY{n}{xpath}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{../@who}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{namespaces} \PY{o}{=} \PY{n}{ns}\PY{p}{)}
             \PY{n}{dirtype} \PY{o}{=} \PY{n}{stage}\PY{o}{.}\PY{n}{xpath}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{@type}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{namespaces} \PY{o}{=} \PY{n}{ns}\PY{p}{)}
             \PY{n}{dirtext} \PY{o}{=} \PY{n}{stage}\PY{o}{.}\PY{n}{xpath}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{.//text()}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{namespaces} \PY{o}{=} \PY{n}{ns}\PY{p}{)}
...
function. But remember that it must be a list!
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}90}]:} \PY{k}{for} \PY{n}{stage} \PY{o+ow}{in} \PY{n}{allstages}\PY{p}{:}
             \PY{n}{results} \PY{o}{=} \PY{p}{[}\PY{p}{]}
             \PY{n}{who} \PY{o}{=} \PY{n}{stage}\PY{o}{.}\PY{n}{xpath}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{../@who}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{namespaces} \PY{o}{=} \PY{n}{ns}\PY{p}{)}
             \PY{n}{dirtype} \PY{o}{=} \PY{n}{stage}\PY{o}{.}\PY{n}{xpath}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{@type}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{namespaces} \PY{o}{=} \PY{n}{ns}\PY{p}{)}
             \PY{n}{dirtext} \PY{o}{=} \PY{n}{stage}\PY{o}{.}\PY{n}{xpath}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{.//text()}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{namespaces} \PY{o}{=} \PY{n}{ns}\PY{p}{)}
...
\end{enumerate}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}74}]:} \PY{n}{allresults} \PY{o}{=} \PY{p}{[}\PY{p}{]}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}75}]:} \PY{n}{headers} \PY{o}{=} \PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{speakerID}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{directionType}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{directionText}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}78}]:} \PY{k+kn}{import} \PY{n+nn}{csv}
